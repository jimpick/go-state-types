...
import (
	...
	"github.com/jimpick/go-state-types/builtin/v10/account"
	"github.com/jimpick/go-state-types/builtin/v10/cron"
	"github.com/jimpick/go-state-types/builtin/v10/datacap"
	"github.com/jimpick/go-state-types/builtin/v10/eam"
	"github.com/jimpick/go-state-types/builtin/v10/evm"
	init_ "github.com/jimpick/go-state-types/builtin/v10/init"
	"github.com/jimpick/go-state-types/builtin/v10/market"
	"github.com/jimpick/go-state-types/builtin/v10/miner"
	"github.com/jimpick/go-state-types/builtin/v10/multisig"
	"github.com/jimpick/go-state-types/builtin/v10/paych"
	"github.com/jimpick/go-state-types/builtin/v10/power"
	"github.com/jimpick/go-state-types/builtin/v10/reward"
	"github.com/jimpick/go-state-types/builtin/v10/system"
	"github.com/jimpick/go-state-types/builtin/v10/util/smoothing"
	"github.com/jimpick/go-state-types/builtin/v10/verifreg"
)
